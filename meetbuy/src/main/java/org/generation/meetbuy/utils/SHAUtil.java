package org.generation.meetbuy.utils;
...
public class SHAUtil {
	...
	public static String createHash(String value) { //12345
		...
		try {
			...
			md.update(value.getBytes()); //le paso a ese messagedigest el valor y convertirlo en bytes (parseando)
	...
	//12345 y codificada es def919dkco2930l20d
